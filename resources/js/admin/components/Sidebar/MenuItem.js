...
class MenuItem extends React.Component {
  render() {
    return (
      ...
      >
        {this.props.icon && <FontAwesomeIcon size="2x" transform="shrink-4" icon={this.props.icon} fixedWidth />}
        {this.props.image && <StyledImage src={this.props.image} alt="avatar" />}
