    ...
    <Grid>
      <LeftColumn>
        ...
        <PricingTable>
          <PricingItem>
            <PaymentMethod>
              <FontAwesomeIcon icon={faMobileAlt} fixedWidth /> {t('shop:paymentMethods.sms')}:
            </PaymentMethod>
            <Badge>12,07 zł</Badge>
          </PricingItem>
          <PricingItem>
            <PaymentMethod>
              <FontAwesomeIcon icon={faLock} fixedWidth /> {t('shop:paymentMethods.psc')}:
            </PaymentMethod>
            <Badge>12,00 zł</Badge>
          </PricingItem>
          <PricingItem>
            <PaymentMethod>
              <FontAwesomeIcon icon={faPaypal} fixedWidth /> {t('shop:paymentMethods.paypal')}:
            </PaymentMethod>
            <Badge color={colors.success}>10,00 zł</Badge>
          </PricingItem>
          <PricingItem>
            <PaymentMethod>
              <FontAwesomeIcon icon={faCreditCard} fixedWidth /> {t('shop:paymentMethods.transfer')}:
            </PaymentMethod>
      ...
      <RightColumn>
        ...
        <ServiceDescription>
          <p>
            ...
            id neque. Interdum et malesuada fames ac ante ipsum primis in faucibus.
          </p>
          <p>
