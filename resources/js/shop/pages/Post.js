        ...
        return (
            <>
                ...
                <PostHeadingGrid>
                    ...
                    <PostHeading>
                        <PostTitle>
                            Hello world with image and content!
                        </PostTitle>
                        <PostInfo>
                            <FontAwesomeIcon
                                icon={faClock}
                        ...
                        <PostPrefaceContent>
                            ...
                            elit. In pharetra placerat sollicitudin. Mauris
                            blandit lacus ut odio dapibus elementum. Etiam
                            consequat lorem dolor, quis pretium turpis sodales
                            id. Vivamus semper auctor fermentum. Aenean dapibus
                            lacinia mauris nec hendrerit. Pellentesque habitant
                            morbi tristique senectus et netus et malesuada fames
                            ac turpis egestas. Aenean nisi odio, varius eu
                            faucibus nec, molestie id neque. Interdum et
                            malesuada fames ac ante ipsum primis in faucibus.
                            Nulla non vestibulum massa, vitae ultrices purus.
                            Integer a malesuada dui, pharetra ultrices felis.
                            Praesent et libero eget dui rhoncus efficitur.
                            Phasellus aliquet felis a nisi volutpat, et ultrices
                            elit maximus. In euismod vestibulum lorem non
                            dapibus. Mauris scelerisque commodo mauris, non
                            ultricies nisi vulputate at. Fusce id eros
                            elementum, molestie justo hendrerit, fermentum quam.
                            Nulla mattis enim sed ornare aliquet. Lorem ipsum
                            dolor sit amet, consectetur adipiscing elit. In
                            pharetra placerat sollicitudin. Mauris blandit lacus
                            ut odio dapibus elementum. Etiam consequat lorem
                            dolor, quis pretium turpis sodales id.Lorem ipsum
                            dolor sit amet, consectetur adipiscing elit. In
                            pharetra placerat sollicitudin.
                        </PostPrefaceContent>
                    </PostHeading>
                </PostHeadingGrid>
                <PostContent>
                    <p>
                        ...
                        non vestibulum massa, vitae ultrices purus. Integer a
                        malesuada dui, pharetra ultrices felis. Praesent et
                        libero eget dui rhoncus efficitur. Phasellus aliquet
                        felis a nisi volutpat, et ultrices elit maximus. In
                        euismod vestibulum lorem non dapibus. Mauris scelerisque
                        commodo mauris, non ultricies nisi vulputate at. Fusce
                        id eros elementum, molestie justo hendrerit, fermentum
                        quam. Nulla mattis enim sed ornare aliquet.
                    </p>
                    <p>
                        ...
                        eleifend tortor consectetur. Etiam nec convallis magna.
                        Duis dignissim condimentum lectus, et consequat erat
                        efficitur at.
                    </p>
                    <p>
